...
/** @nocollapse */ VgModuloComponent.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "15.0.4", ngImport: i0, type: VgModuloComponent, deps: [], target: i0.ɵɵFactoryTarget.Component });
/** @nocollapse */ VgModuloComponent.ɵcmp = i0.ɵɵngDeclareComponent({ minVersion: "14.0.0", version: "15.0.4", type: VgModuloComponent, selector: "vg-modulo", inputs: { moduloConfig: "moduloConfig", audioElement: "audioElement" }, viewQueries: [{ propertyName: "waveCanvas", first: true, predicate: ["waveCanvas"], descendants: true }], ngImport: i0, template: "<canvas #waveCanvas></canvas>\n" });
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "15.0.4", ngImport: i0, type: VgModuloComponent, decorators: [{
            type: Component,
